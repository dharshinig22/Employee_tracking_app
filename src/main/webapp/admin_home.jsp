...
<style>
    body {
        ...
        background-image: url('img/emp8.jpg'); /* Replace with your image URL */
...
<div class="container">
    ...
    <form action="admin_add_emp" method="post">
        ...
        <div>
            ...
            <input type="password" name="emp_pass" placeholder="Enter password" required/>
        </div>
    ...
    <div class="list-employees">
        <table>
            ...
            try{
                ...
                PreparedStatement pst= con.prepareStatement("SELECT emp_id, emp_name, phone_num, email, age, role FROM employee_table");
